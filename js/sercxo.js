...
//分岐處理本體
	switch (sxlosil) {
case "af":URL='porFari.php';break;//aferoj por fari
...
case "asa":URL=`./?t=lt`;break;
case "ascii":URL=`${lab}log/?t=ascii`;break;
case "arv":URL=`${l}ar_v_tablo.php`;break;
case "bb": URL=`${l}manduuka/babelbible`;break;
...
case "ck" :URL=`${l}ru.php?t=vv2_1#栞`;break;
case "cn" :URL=`${h}ci.nii.ac.jp/search?q=${vort}&range=0&count=20&sortorder=1&type=0`;break;
case "css":case "cssmdn":URL=google(vort,"mdn css ");break;
case 'cssq' :URL=htmq(vort,'style');break;
case 'css3':URL=htmq(vort,'css'  );break;
case "csss":URL=`${lab}cssSecrets/`;break;
case "ct" :URL=`${s}ctext.org/pre-qin-and-han/zh?searchu=${vort}`;break;
case "ddg":case "dgg":URL=`${l}ref.php?t=bo_ddg`;break;
case "dpp":URL=`${s}dopeoplesay.com/q/${vort}`;break;
case "de" :URL=`${h}www.dict.cc/?s=${vort}`;break;
case "dk"  :URL=`${l}kv_uni.php?s=DK`;break;
case "dl" :URL=`../legxo/DLVI.php?t=`;URL+=vort?vort:'pagxtabelo';break;
case "ec" :URL=`${h}oxford${d}.so8848.com/search?word=${vort}`;break;
case "ee" :URL=`${h}www.etymonline.com/search?q=${vort}`;break;
case "ekpa":URL=`${l}ekpa/`;break;
case "el" :URL=`${h}logeion.uchicago.edu/${vort}`;break;
case "em" :URL='./';break;
case "eman":URL=`${s}eman-physics.net/${vort}`;break;
//case "enl":URL="https://www.lexico.com/definition/"+vort;break;
...
//case "entt": URL = "https://tt.oxforddictionaries.com/тәрҗемә-итегез/инглизчә-татарча/" + vort;break;
...
case "eomaho"  :URL=`${l}ref.php?t=eo_vortetoj`;break;
case "eogim"  :URL=`${l}ref.php?t=eo_vortoj`;break;
...
case "gh"  :URL=`${s}tlistlil.github.io/sps/`;break;
case "gx"	:URL='ligoj_gxe.php';break;
case "hani"	:URL=`${l}sk/Hani/`;break;
...
case "hoshi":URL=`${l}ref.php?t=bo_hoshi`;break;
case "html"	:URL=google(vort,"mdn html ");break;
case 'htmq'	:URL=htmq(vort);break;
case "ip"	:URL=`${l}ip/`;break;
...
case "ja"  :URL=`${s}kotobank.jp/word/${vort}#E7.B2.BE.E9.81.B8.E7.89.88.20.E6.97.A5.E6.9C.AC.E5.9B.BD.E8.AA.9E.E5.A4.A7.E8.BE.9E.E5.85.B8`;break;
case "jank":URL=`${s}japanknowledge-com.ouj.idm.oclc.org/library/`;break;
//case "jank":URL=`${s}japanknowledge-com.libproxy.ouj.ac.jp/lib/search/basic/index.html?q1=&r1=1&phrase=0&sort=1&cids=20020&rows=20&pageno=1&s=f`;break;
case "jbo" :URL=`${l}jbo/src.php?q=${vort}`;break;
case "jbox" :URL=`${l}jbo/src.php?q=${vort}&ekzakte=on`;break;
//case "jbo" :URL=`${s}vlasisku.lojban.org${vort}`;break;
//case "jbo":URL=`${s}jbovlaste.lojban.org/lookup.pl?Form=lookup.pl1&Query=${vort}&Strategy=*&Database=*`;break;
case "jbomao"  :URL=`${l}ref.php?t=jbo_cmavo`;break;
case "jbogim"  :URL=`${l}ref.php?t=jbo_gismu`;break;
case "js"  :URL=google(vort,"javascript ");break;
...
//case "kkk":URL = `${s}kukuklok.com`;break;
case "kl"  :URL=`${l}kv_uni.php?s=Latn`;break;
case "klam":URL=`${l}kv_uni.php?s=Ethi`;break;
case "klbe":URL=`${l}kl_ru.php?opt=be`;break;
case "klbo":URL=`${l}kl2_bo.php?lingvo=bo`;break;
case "klde":URL=`${l}kv_uni.php?s=de`;break;
case "kldoref":URL=`${l}kl_ru.php?opt=dorev`;break;
case "kldorev":URL=`${l}kl_ru.php?opt=dorev`;break;
case "klek":URL=`${l}kv_uni.php?s=EKPA`;break;
case "klen":URL=`${l}eu/kl_Shaw.php`;break;
case "klel":URL=`${l}kv_uni.php?s=el`;break;
case "klfa":URL=`${s}${tr}.google.ru/?hl=ru#fa/en/`;break;
case "klfr":URL=`${l}kl3.php?lingvo=be`;break;
case "klga":URL=`${l}kv_uni.php?s=ga`;break;
case "klhe":URL=`${l}sem/kl_sem.php?lingvo=he`;break;
case "klhi":URL=`${l}sk/Brah/kv_Brah.php?dsk=Deva`;break;
case "klhy":URL=`${sw}branah.com/armenian`;break;
case "klipa":URL=`${l}kv_uni.php?s=IPA`;break;
case "klja":URL=`${l}kv_ja.php`;break;
case "klkm":URL=`${l}sk/Brah/kv_Brah.php?dsk=Khmr`;break;
case "klko":URL=`${l}kl_ko.php`;break;
case "klky":URL=`${l}kl_ru.php?opt=ky`;break;
case "klmn":URL=`${l}kv_uni.php?s=mn`;break;
case "klmy":URL=`${l}kl2_bo.php?lingvo=my`;break;
case "kloj":URL=`${l}kv_uni.php?s=ja`;break;
case "klor":URL=`${l}sk/Brah/kv_Brah.php?dsk=Orya`;break;
case "klpi":URL=`${l}sk/Brah/kv_Brah.php`;break;
case "klsa":URL=`${l}sk/Brah/kv_Brah.php`;break;
case "klth":URL=`${l}kl2_bo.php?lingvo=th`;break;
case "kltt":URL=`${l}kv_uni.php?s=tt`;break;
case "klru":URL=`${l}kl_ru.php`;break;
case "kluk":URL=`${l}kl_ru.php?opt=uk`;break;
case "klur":URL=`${s}${tr}.google.ru/?hl=ru#ur/en/`;break;
case "kluz":URL=`${l}kl_ru.php?opt=uz`;break;
case "klzh":URL=`${l}kl2_bo.php?lingvo=zh`;break;
...
case "kr"	:URL=`${l}ip/?t=kyouro`;break;
case "kv"  :URL='konvertilo.php';break;
case "kvko":URL=`${l}kv_ja.php`;break;
case "la"  :URL=`${h}logeion.uchicago.edu/${vort}`;break;
case "labo":URL=`${lab}labo.php`;break;
case "lam":URL=`${l}sem/amh/`;break;
case "lbo":URL=`${l}ref.php?t=bo_bo`;break;
case "leg" :URL=`./?t=legosignoj`;break;
case "lernu":URL`${s}lernu.net/vortaro`;break;
case "leu":URL=`${l}eu/`;break;
case "lfa":URL=`${l}ref.php?t=fa`;break;
case "lg": URL=`./ligoj/`;break;
case "lga":URL=`${l}eu/?t=ga_tab`;break;
case "lgmn": URL=`ligoj_gxe.php`;break;
case "lhe":URL=`${l}sem/heb/`;break;
case "lingvo":URL=`${l}`;break;
case "lja" :URL=`${l}ip/`;break;
case "ljbo":URL=`${l}jbo/`;break;
case "lko" :URL=`${l}ip/?t=kor`;break;
case "ll": URL=`./?t=legosignoj`;break;
case "lm": URL=`ligoj_muz.php`;break;
case "lr": URL=`./?t=rom`;break;
case "lru":URL=`${l}ru/`;break;
case "lrw":URL=`${l}ref/rw/`;break;
case "lt": URL=`./?t=lt`;break;
case "ltt":URL=`${l}ref.php?t=tt`;break;
case "lzh":URL=`${l}zh/`;break;
case "ma": URL=`maruya.php?wiki=0&tiparo=Jpan&duone=1`;break;
case "max": URL=`${lab}tolo/?t=pentraro`;break;
case "mand": URL=`${l}manduuka/`;break;
case "maz": URL=`maruya.php?wiki=0&tiparo=Jpan&duone=1&malduone=1`;break;
case "mb": URL=`maruya.php?wiki=0&tiparo=Jpan&brOpt=1&duone=1`;break;
case "mbz": URL=`maruya.php?wiki=0&tiparo=Jpan&brOpt=1&duone=1&malduone=1`;break;
//case "mb": URL=`${l}kv_uni.php?check=1`;break;
case "md": URL=`${lab}log/?t=listo`;break;
...
case "oml":URL=`${sw}oml.city.osaka.lg.jp/licsxp-opac/WOpacEsSchCmpdDispAction.do`;break;
case "opl":URL=`${sw}library.pref.osaka.jp/opw/OPW/OPWSRCH2.csp`;break;
case "osm":URL=`${sw}openstreetmap.org/search?query=${vort}`;break;
case "ou": URL=`../ouj/ouj.php`;break;
case "phpf":vort=vort.replace(/_/g,	'-');
			URL=`${s}www.php.net/manual/ja/function.${vort}.php`;break;
case "phpt":URL=`${s}www.php.net/manual/ja/language.types.${vort}.php`;break;
...
case "qwt": URL=`${l}manduuka/zh/info/`;break;
case "ref": URL =`${l}ref.php?t=ref`;break;
case "refbo": URL =`${l}ref.php?t=ref`;break;
case "reffa": URL =`${l}ref.php?t=fa`;break;
case "refko": URL =`${l}ref.php?t=kor_pt`;break;
case "refru": URL =`${l}ref.php?t=ru`;break;
case "ru":URL=`${h}yakuru.net/search.aspx?w=${vort}`;break;
case "rw":URL=`${h}kinyarwanda.net/index.php?q=${vort}`;break;
case "rw2":URL=`${sw}webonary.org/kinyarwanda?s=${vort}&search=Search&key=rw&semantic_domain=&search_options_set=1&match_whole_words=1`;break;
case "sa":URL=`${h}www.manduuka.net/sanskrit/w/dic.cgi?word=${vort}`;break;
case "sidd":URL=`${l}sk/Brah/kv_Brah.php?dsk=Sidd`;break;
case "sk": URL =`${l}ref.php?t=skribsistemo`;break;
case "sl": URL=google(vort,"scilab ");break;
case "sw": URL =`${s}swahili-${d}.com/swahili-english/${vort}_${vort}`;break;
case "swv":URL=`${l}sw_v_tablo.php`;break;
case "tang":URL=`${l}sk/Tang/`;break;
case "te": URL=`${sw}nisanyansozluk.com/kelime/${vort}`;break;
case "th":URL=`${h}www.thai-language.com/dict`;break;
case "tl":URL=`porFari.php`;break;
case "tlin":URL=`${l}ref/tlin/`;break;
case "tr": URL=`${s}${tr}.google.ru/?hl=ru#${vort}`;break;
case "ts": URL=`transito.php`;break;
case "tt": URL=`${l}ref.php?t=tt`;break;
//case "tten": URL = "https://tt.oxforddictionaries.com/тәрҗемә-итегез/татарча-инглизчә/" + vort;break;
case "ttru":URL=`${l}ref.php?t=../../lib/tt_ru_txt/a`;break;
case "tw":URL=`${s}${tr}.google.ru/?hl=ru#en/zh-TW/${vort}`;break;
case "txt"  :URL=`../teksto/`;break;
...
case "unic":URL=`${s}unicode-table.com/ru/`;break;
case "ur"  :URL=`${s}www.urban${d}.com/define.php?term=${vort}`;break;
case "utf" :URL=`${lab}?t=signoj`;break;
case "utf8":URL=`${lab}labo.php#utf`;break;
case "uz":URL=`${s}ctild.sitehost.iu.edu/Main/Uzbek-EnglishDictionary`;break;
//case "uz":URL=`${s}www.uzbek-${d}.org/search/uz?word=${vort}`;break;
case "uzko":URL="https://dict.naver.com/uzkodict/#/search?query=" + vort;break;
case "vv":URL=`${l}ru.php?t=vv2_1#栞`;break;
...
case "wtja"	:URL=`${s}ja.${wikt}.org/wiki/${vort}`;break;
...
case "дкг"	:URL=`${l}ru/`;break;
case "кл"	:URL=`${l}kl_ru.php`;break;
case "пв"	:URL=`${s}${tr}.google.ru/?hl=ru#ru/en/${vort}`;break;
case "пвтт"	:URL=`${s}${tr}.google.ru/?hl=ru#tt/en/${vort}`;break;
case "рутт"	:URL=`${s}tatpoisk.net/dict/${vort}`;break;
case "тт"	:URL=`${l}ref.php?t=tt`;break;
//case "ттен": URL = "https://tt.oxforddictionaries.com/тәрҗемә-итегез/татарча-инглизчә/" + vort;break;
case "ттру"	:URL=`${l}ref.php?t=../../lib/tt_ru_txt/a`;break;
...
case "як"	:URL=`${h}yakuru.net/search.aspx?w=${vort}`;break;
case "яп"	:URL=`${s}${tr}.yandex.ru/?lang=${vort}`;break;
