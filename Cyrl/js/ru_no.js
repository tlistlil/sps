...
let do20_de=['','одного́','двух','трёх','четырёх','пяти́','шести́','семи́','восьми́','девяти́','десяти́','оди́ннадцати','двена́дцати','трина́дцати','четы́рнадцати','пятна́дцати','шестна́дцати','семна́дцати','восемна́дцати','девятна́дцати','двадцати́'];
let do20_al=structuredClone(do20_de);
do20_al[1]='одному́';
do20_al[2]='двум';
do20_al[3]='трём';
do20_al[4]='четырём';
let do20_kn=['','одни́м','двумя́','тремя́','четырьмя́','пятью́','шестью́','семью́','восьмью́','девятью́','десятью́','оди́ннадцатью','двена́дцатью','трина́дцатью','четы́рнадцатью','пятна́дцатью','шестна́дцатью','семна́дцатью','восемна́дцатью','девятна́дцатью','двадцатью́'];
let do20_en=structuredClone(do20_de);do20_en[1]='одно́м';
let do100=['','','два́дцать','три́дцать','со́рок','пятьдеся́т','шестьдеся́т','се́мьдесят','во́семьдесят','девяно́сто'];
